	...
	<hr />
	 ...
	 <section id="container">
	  ...
	  <table>
	   ...
	   <tr>
		    <td>${list.idx}</td>
		    <td><a href="/board/read?idx=${list.idx}&
		    						page=${scri.page}&
...
<div>
 <ul>
  <c:if test="${pageMaker.prev}">
   <li><a href="listPage${pageMaker.makeSearch(pageMaker.startPage - 1)}">이전</a></li>
  </c:if> 
  ...
  <c:if test="${pageMaker.next && pageMaker.endPage > 0}">
   <li><a href="listPage${pageMaker.makeSearch(pageMaker.endPage + 1)}">다음</a></li>
  </c:if> 
 </ul>
</div>	
